        ...
        {showForm && (
          <div style={{
            ...
            <div style={{display:'flex',gap:'10px'}}>
              <button onClick={addClient} disabled={saving || !form.name} style={{
                background:'#d4af37',color:'white',border:'none',
        ...
        {loading ? (
          ...
          <div style={{
            ...
            <button onClick={() => setShowForm(true)} style={{
              background:'#d4af37',color:'white',border:'none',
              borderRadius:'10px',padding:'10px 24px',cursor:'pointer',marginTop:'12px',fontWeight:'600'
            }}>
            ...
            {clients.map(client => (
              <div key={client.id} style={{
                ...
                <div style={{
                  ...
                  color:'#d4af37',fontWeight:'700',fontSize:'16px',flexShrink:0
                }}>
                  {client.name?.charAt(0).toUpperCase()}
                </div>
                <div style={{flex:1,minWidth:0}}>
                  <p style={{fontWeight:'600',margin:'0 0 2px',fontSize:'15px'}}>{client.name}</p>
                  <p style={{color:'rgba(255,255,255,0.4)',margin:0,fontSize:'12px',overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{client.email || client.phone || '—'}</p>
                </div>
              </div>
            ))}
          </div>
