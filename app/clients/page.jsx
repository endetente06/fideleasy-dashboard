    ...
    <div style={{display:'flex',minHeight:'100vh',background:'#07070f',color:'white',fontFamily:'system-ui,sans-serif'}}>
      ...
      <div style={{marginLeft:'240px',flex:1,padding:'32px'}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'32px'}}>
          ...
          <button onClick={() => setShowForm(!showForm)} style={{background:'#d4af37',color:'white',border:'none',borderRadius:'10px',padding:'10px 20px',cursor:'pointer',fontSize:'14px',fontWeight:'600'}}>
            + Ajouter un client
          </button>
        </div>
          ...
          <div style={{background:'#0f0f1c',border:'1px solid #1e1e35',borderRadius:'16px',padding:'24px',marginBottom:'24px'}}>
            ...
            <div style={{display:'flex',gap:'12px'}}>
              <button onClick={addClient} disabled={saving || !form.name}
                style={{background:'#d4af37',color:'white',border:'none',borderRadius:'8px',padding:'10px 24px',cursor:'pointer',fontSize:'14px',fontWeight:'600'}}>
        ...
        {loading ? (
          ...
          <div style={{textAlign:'center',padding:'60px',background:'#0f0f1c',border:'1px solid #1e1e35',borderRadius:'16px'}}>
            ...
            <button onClick={() => setShowForm(true)} style={{background:'#d4af37',color:'white',border:'none',borderRadius:'10px',padding:'10px 24px',cursor:'pointer',marginTop:'12px'}}>
              ...
              <tbody>
                {clients.map((client, i) => (
                  <tr key={client.id} style={{borderBottom: i < clients.length-1 ? '1px solid #1e1e35' : 'none'}}>
                    ...
                    <td style={{padding:'16px 20px'}}>
                      <a href="#" style={{background:'rgba(212,175,55,0.1)',color:'#d4af37',borderRadius:'6px',padding:'6px 12px',fontSize:'12px',textDecoration:'none',fontWeight:'600'}}>
                        Voir carte
                      </a>
                    </td>
                  </tr>
